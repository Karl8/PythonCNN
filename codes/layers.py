...
class Linear(Layer):
    def __init__(self, name, in_num, out_num, init_std):
        ...
        self.info = {}
        self.info['name'] = name
        self.info['in_num'] = in_num
        self.info['out_num'] = out_num
        self.info['init_std'] = init_std
...
class Conv2D(Layer):
    def __init__(self, name, in_channel, out_channel, kernel_size, pad, init_std):
        ...
        self.info = {}
        self.info['name'] = name
        self.info['in_channel'] = in_channel
        self.info['out_channel'] = out_channel
        self.info['kernel_size'] = kernel_size
        self.info['pad'] = pad
        self.info['init_std'] = init_std
